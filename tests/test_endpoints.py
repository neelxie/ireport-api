...
class TestIncident(TestStructure):
    ...
    def test_add_redflag(self):
        ...
        one_redflag = self.app.get('/api/v1/red-flags/1',
            content_type='application/json', headers=self.headers)
        ...
        user_redflags = self.app.get('/api/v1/auth/users/1/red-flags',
            content_type='application/json', headers=self.headers)
    ...
    def test_retrieve_all_users(self):
        ...
        response = self.app.get('/api/v1/auth/users', content_type='application/json', headers=self.headers)
        self.assertEqual(response.status_code, 400)

    def test_fetch_user(self):
        """ Fetch user. """
        response = self.app.get('/api/v1/auth/users/1', content_type='application/json', headers=self.headers)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data.decode(),
