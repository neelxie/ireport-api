...
## Features
  ...
  |  GET | /api/v1/interventions | Fetch all interventions records. | User 
  |  GET | /api/v1/interventions/[intervention_id] | Fetch a specific intervention by id. | User
  |  GET | /api/v1/auth/users/[user_id]/interventions | Fetch a specific intervention by id. | User
  |  PATCH | /api/v1/interventions/[intervention_id]/location | Edit/Change location of intervention. | User
  |  PATCH | /api/v1/interventions/[intervention_id]/comment | Edit/Change comment of intervention. | User
  |  PATCH | /api/v1/interventions/[intervention_id]/status | Change status of intervention. | Admin
  |  DELETE | /api/v1/interventions/[intervention_id] | Delete intervention. | User
  |  POST | /api/v1/interventions | Create a intervention record. | User
